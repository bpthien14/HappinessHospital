...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Hospital Patients Service API',
    'DESCRIPTION': 'Patient management service for Hospital Management System',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'TAGS': [
        {'name': 'patients', 'description': 'Patient management endpoints'},
        {'name': 'medical-records', 'description': 'Medical record management'},
