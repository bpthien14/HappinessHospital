        ...
        for i in range(count):
            try:
                ...
                patient = Patient.objects.create(
                    ...
                    emergency_contact_phone=self.generate_phone() if random.choice([True, False]) else None,
                    emergency_contact_relationship=random.choice(['Vợ/Chồng', 'Con', 'Cha/Mẹ', 'Anh/Chị em']) if random.choice([True, False]) else None,
